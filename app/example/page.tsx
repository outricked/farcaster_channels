...
export default function Example(){
    return (
    <main className="max-w-screen-xl mx-auto lg:flex lg:flex-row">
    <aside id="logo-sidebar" className="lg:flex lg:flex-col" aria-label="Sidebar">
    ...
    <div className="lg:flex lg:flex-col min-h-screen items-center justify-between p-48 border-white border-8">
